...
| B 验证资产复利 | P4/M3 | 出口闸 done token+任务级进化+金标准 40→500+ | 🚧 WBS 已细化（B1-B6），动工中 |
| C 机器控制面 | P1 | 本机 API 网关+风控信任+审批密码学+7 天无人值守 | ⏳ |
| D 网络节点 | P3/E | x402 客户端+git-native 市场+跨标准适配器+IM 侧挂 | ⏳ |
| E 商业治理 | B | 章程三律+小时数定价+open-core 2.0 | ⏳ |
