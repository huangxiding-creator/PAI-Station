...
for label, val in [("提案版本","V3.0（操作手册级 · 含智能复利引擎 + 红队质询应答 + 用户主权十维灵活性 + 竞品源码级全维超越）"),("提案日期","2026 年 9 月 6 日"),("状态","待批准（批准 / 修订 / 否决）"),("研发基线","350 项开源调研 · 5 竞品源码级研读（最新 main 分支） · 22 项竞品优点吸收落点 · 32 个思维模型（含曾鸣三部曲） · 18 章 + 19 附录 · 红队 13 问全落解 · 十维灵活性 300+ 配置项")]:
