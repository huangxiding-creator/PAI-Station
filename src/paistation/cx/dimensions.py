...
LEVEL_EVIDENCE: dict[Dimension, str] = {
    ...
    Dimension.RELATION: "实体登记表 27145（person 26951/org 177/project 17；四渠道：微信好友 2832+微信 166 群成员+飞书 29 p2p 与 12 群+企微会议参与人+git 作者）+ 边 34384（friend_of 2746/member_of 31608/associate_of 30）；主人四标识锚定（git 邮箱×微信号×wxid×企微 userid）；企微 77 场会议详情已入 20 场（频控断点续跑中），钉钉未登录",
